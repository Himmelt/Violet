...
public final class Helper {
    ...
    public static void sendChatType(@NotNull Player player, @NotNull ChatType type, @NotNull String text) {
        if (MC_VERSION == v1_7_10) {
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_8_R1.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_8_R1.PacketPlayOutChat((net.minecraft.server.v1_8_R1.IChatBaseComponent) component, (byte) type.ordinal());
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_8_R1.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_8_R2.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_8_R2.PacketPlayOutChat((net.minecraft.server.v1_8_R2.IChatBaseComponent) component, (byte) type.ordinal());
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_8_R2.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_8_R3.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_8_R3.PacketPlayOutChat((net.minecraft.server.v1_8_R3.IChatBaseComponent) component, (byte) type.ordinal());
                // packet.components = components;
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_9_R1.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_9_R1.PacketPlayOutChat((net.minecraft.server.v1_9_R1.IChatBaseComponent) component, (byte) type.ordinal());
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_9_R1.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_9_R2.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_9_R2.PacketPlayOutChat((net.minecraft.server.v1_9_R2.IChatBaseComponent) component, (byte) type.ordinal());
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_9_R2.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_10_R1.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_10_R1.PacketPlayOutChat((net.minecraft.server.v1_10_R1.IChatBaseComponent) component, (byte) type.ordinal());
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_10_R1.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_11_R1.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_11_R1.PacketPlayOutChat((net.minecraft.server.v1_11_R1.IChatBaseComponent) component, (byte) type.ordinal());
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_11_R1.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_12_R1.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_12_R1.PacketPlayOutChat((net.minecraft.server.v1_12_R1.IChatBaseComponent) component,
                ...
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_12_R1.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_13_R1.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_13_R1.PacketPlayOutChat((net.minecraft.server.v1_13_R1.IChatBaseComponent) component,
                ...
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_13_R1.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_13_R2.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_13_R2.PacketPlayOutChat((net.minecraft.server.v1_13_R2.IChatBaseComponent) component,
                ...
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_13_R2.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_14_R1.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_14_R1.PacketPlayOutChat((net.minecraft.server.v1_14_R1.IChatBaseComponent) component,
                ...
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_14_R1.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_15_R1.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_15_R1.PacketPlayOutChat((net.minecraft.server.v1_15_R1.IChatBaseComponent) component,
                ...
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_15_R1.Packet) packet);
            }
            ...
            if (connection != null) {
                Object component = new net.minecraft.server.v1_16_R1.ChatComponentText(text);
                Object packet = new net.minecraft.server.v1_16_R1.PacketPlayOutChat((net.minecraft.server.v1_16_R1.IChatBaseComponent) component,
                ...
                // packet.components = components;
                connection.sendPacket((net.minecraft.server.v1_16_R1.Packet) packet);
            }
        } else {
            player.sendMessage(text);
        }
